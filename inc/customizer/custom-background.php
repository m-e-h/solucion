...
add_action( 'after_setup_theme', 'solucion_custom_background_setup', 15 );

# Filter the background color late.
add_filter( 'theme_mod_background_color', 'solucion_background_color', 95 );
 ...
 * @return void
 */
function solucion_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'solucion_custom_background_callback',
		)
	);
}
 ...
 * @return string
 */
function solucion_background_color( $color ) {
 ...
 * @return void
 */
function solucion_custom_background_callback() {
