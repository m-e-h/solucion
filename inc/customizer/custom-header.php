 ...
 * @link       http://themehybrid.com/themes/solucion
 * @license    http://www.gnu.org/licenses/old-licenses/gpl-2.0.html
 */

# Call late so child themes can override.
add_action( 'after_setup_theme', 'solucion_custom_header_setup', 15 );
 ...
 * @return void
 */
function solucion_custom_header_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'header-text'            => true,
			'uploads'                => true,
			'wp-head-callback'       => 'solucion_custom_header_wp_head'
		)
	);
}
 ...
 * @return void
 */
function solucion_custom_header_wp_head() {
$style = '';
